...
def init_database():
    ...
    with app.app_context():
        ...
        for lot_data in sample_lots:
            ...
            print(f"Creating {lot_data['number_of_spots']} spots for {lot_data['prime_location_name']}...")
        ...
        print(f"Created admin user: {app.config['ADMIN_USERNAME']} / {app.config['ADMIN_PASSWORD']}")
        print("Created sample users:")
        for user_data in sample_users:
            print(f"  - {user_data['username']} / {user_data['password']}")
        print("Created parking lots:")
        for lot_data in sample_lots:
            print(f"  - {lot_data['prime_location_name']} ({lot_data['number_of_spots']} spots)")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Database management for Vehicle Parking App')
